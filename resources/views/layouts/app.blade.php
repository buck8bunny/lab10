...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="https://infyom.com/static/f9cfd0f86a2dba59edab2dd31b9e3146/b4859/logo.webp" width="60" height="30"
             alt="InfyOm Logo">
        <img class="navbar-brand-minimized" src="https://infyom.com/static/f9cfd0f86a2dba59edab2dd31b9e3146/b4859/logo.webp" width="60"
    ...
    <ul class="nav navbar-nav ml-auto">
        <li class="nav-item d-md-down-none">
            <a class="nav-link" href="#">
                <i class="icon-bell"></i>
                <span class="badge badge-pill badge-danger badge-js">0</span>
            </a>
        </li>
...
<footer class="app-footer">
    <div>
        ...
        <span>&copy; 2022 InfyOmLabs.</span>
    </div>
    <div class="ml-auto">
